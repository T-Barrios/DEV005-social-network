...
k$1.hb = function() {
  if (this.g) {
    ...
    this.C < b2.length && (ic(this), lc$1(this, a, b2), this.i && 4 != a && N$1(this));
  }
};
function nc(a, b2) {
...
function login(navigateTo2) {
  ...
  onAuthStateChanged(auth, (user) => {
    ...
    if (user) {
      ...
      console.log("y este no s\xE9 (uid): ", uid);
    } else {
...
function post(navigateTo2) {
  ...
  txtPost.textContent = "Chayanne es bac\xE1n.";
